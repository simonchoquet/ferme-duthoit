...
<div class="wrapper-info">
	<div class="col-left">
			  ...
			  <?php esc_attr_e('About Theme Info', 'skt-coffee'); ?>
		   </div>
          <p><?php esc_attr_e('SKT Coffee is a responsive cafe and restaurant WordPress theme which is multipurpose and can be used for hotels, food, recipes, nature, agriculture, business, personal and corporate. Google map compatible for location, Video compatible for videos and qTranslate X compatible for multilingual and translation ready. WooCommerce compatible for Ecommerce and Nextgen Gallery compatible for gallery and portfolio websites. Contact form 7 compatible and WordPress SEO plugins compatible.','skt-coffee'); ?></p>
		  <a href="<?php echo SKT_COFFEE_PRO_THEME_URL; ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/free-vs-pro.png" alt="" /></a>
	</div><!-- .col-left -->
	
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo SKT_COFFEE_LIVE_DEMO; ?>" target="_blank"><?php esc_attr_e('Live Demo', 'skt-coffee'); ?></a> | 
				<a href="<?php echo SKT_COFFEE_PRO_THEME_URL; ?>"><?php esc_attr_e('Buy Pro', 'skt-coffee'); ?></a> | 
				<a href="<?php echo SKT_COFFEE_THEME_DOC; ?>" target="_blank"><?php esc_attr_e('Documentation', 'skt-coffee'); ?></a>
                <div style="height:5px"></div>
				<hr />                
                <a href="<?php echo SKT_COFFEE_THEMES; ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/sktskill.jpg" alt="" /></a>
			</div>		
	</div><!-- .col-right -->
</div><!-- .wrapper-info -->
<?php } ?>